...
#     client = BaseClientOpenTelemetry(url="http://base_url/endpoint")
#     query_str = """
#     query Abc($v: String!) {
#         abc(v: $v) {
#             field1
...
#     client.execute(query_str, "Abc", {"v": "Xyz"})
...
#     httpx_mock.add_response()
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     query_str = """
...
#     client.execute(query_str, "Abc", {"arg": arg_value})
...
#     httpx_mock.add_response()
#     client = BaseClientOpenTelemetry(
...
# def test_execute_passes_kwargs_to_json_post(mocker, tracer):
...
# @pytest.mark.parametrize("tracer", ["tracer name", None])
# def test_execute_sends_json_request_with_headers_from_passed_kwargs(httpx_mock, tracer):
#     httpx_mock.add_response()
#     client = BaseClientOpenTelemetry(
#         url="http://base_url",
#         headers={
...
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     client.execute(query_str, "Abc", {"file": txt_file})
...
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     client.execute(query_str, "Abc", {"file": in_memory_txt_file})
...
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     client.execute(query_str, "Abc", {"files": [txt_file, png_file]})
...
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     client.execute(query_str, "Abc", {"input": InputType(file_=txt_file)})
...
#     client = BaseClientOpenTelemetry(url="http://base_url")
#     client.execute(query_str, "Abc", {"files": [txt_file, txt_file]})
...
# @pytest.mark.parametrize("tracer", ["tracer name", None])
# def test_execute_passes_kwargs_to_multipart_post(mocker, tracer, txt_file):
#     http_client = mocker.MagicMock()
...
# @pytest.mark.parametrize("tracer", ["tracer name", None])
# def test_execute_sends_multipart_request_with_headers_from_passed_kwargs(
...
#         "base_client_open_telemetry.get_tracer"
#     )
...
#     BaseClientOpenTelemetry(url="http://base_url", tracer="tracker name")
...
#     httpx_mock.add_response()
#     client = BaseClientOpenTelemetry(url="http://base_url", tracer="tracker")
...
#         span.set_attribute.assert_any_call("operationName", "GetHello")
